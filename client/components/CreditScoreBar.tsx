    ...
    <div className="flex flex-col items-center space-y-6" style={{ width: Math.max(width, 300) }}>
      ...
      <div className="w-full" style={{ maxWidth: width }}>
        ...
        <div className="relative">
          ...
          {/* Progress fill */}
          <div 
            className="absolute top-0 left-0 h-8 rounded-full transition-all duration-[2s] ease-out"
            style={{
          ...
          <div 
            className="absolute top-0 w-1 h-8 bg-gray-800 transition-all duration-[2s] ease-out"
            style={{

...
import { CreditCard, Shield, TrendingUp, Users, CheckCircle, ArrowRight } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Get scored based on rent, utilities, and employment history"
    },
    {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogTitle className="text-2xl text-center">Welcome to CreditBridge</DialogTitle>
          <DialogDescription className="text-center text-base">
            The first alternative credit scoring platform that recognizes your true financial responsibility
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-lg border border-green-200">
            <div className="flex items-center mb-2">
              ...
              <span className="font-medium text-green-800">Why CreditBridge Works</span>
            </div>
            <p className="text-sm text-green-700">
              Traditional credit scores ignore rent payments, utility bills, and employment history. 
              We factor in all the financial responsibility you already demonstrate to give you the credit score you deserve.
            </p>
          </div>
          ...
          <div className="flex justify-center space-x-4 pt-2">
            <Badge variant="secondary" className="text-xs">SOC 2 Certified</Badge>

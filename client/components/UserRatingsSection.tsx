...
export default function UserRatingsSection({ 
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      comment: "I had no credit history but CreditBridge used my rent payments and utility bills to show I'm responsible. Got approved for a card with great terms!",
    ...
    },
    {
      ...
      comment: "My traditional score was stuck at 620, but CreditBridge recognized my consistent rent and utility payments. Now I qualify for better rates!",
      scoreImprovement: 87,
      verified: true,
      avatar: "MJ",
      beforeScore: 620,
    ...
    },
    {
      ...
      comment: "Traditional banks didn't understand my freelance income, but CreditBridge looked at my banking patterns and payment history. Game changer!",
    ...
    },
    {
      ...
      comment: "I love that I can see exactly what affects my score. The coaching helped me improve my financial habits and my score jumped 95 points!",
      scoreImprovement: 95,
      verified: true,
      avatar: "DK",
      beforeScore: 640,
    ...
    },
    {
      ...
      comment: "Landlords now see my CreditBridge score and trust my rental history. Finally got approved for the apartment I wanted in downtown Austin!",
      scoreImprovement: 78,
      verified: true,
      avatar: "JT",
      beforeScore: 665,
    ...
    },
    {
      ...
      comment: "Even with limited credit cards, my consistent bill payments and employment history got me pre-approved for an auto loan at 4.2% APR!",
    ...
    },
    {
      ...
      comment: "As an international student with no US credit history, CreditBridge gave me a fair chance using my banking and payment data. Amazing!",
    ...
    },
    {
      ...
      comment: "Traditional lenders rejected my business loan application, but CreditBridge's alternative scoring helped me get approved for expansion funding!",
      scoreImprovement: 67,
      verified: true,
      avatar: "CA",
      beforeScore: 658,
  ...
  const averageImprovement = Math.round(testimonials.reduce((sum, t) => sum + (t.scoreImprovement || 0), 0) / testimonials.length);
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mb-8">
            <div className="flex items-center">
              ...
              <span className="text-2xl font-bold text-gray-900 mr-2">{overallRating.toFixed(1)}</span>
              <span className="text-gray-600">out of 5</span>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">{totalReviews.toLocaleString()}+</div>
              ...
              <CardContent>
                <div className="mb-3">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-gray-600 text-sm pl-3">{testimonial.comment}</p>
                  </div>
                </div>
                ...
                {testimonial.scoreImprovement && (
                  <div className="mt-4 pt-3 border-t">
                    <div className="flex items-center justify-between">
                      ...
                      {testimonial.beforeScore !== undefined && testimonial.afterScore && (
                        <div className="text-xs text-gray-500">
                          {testimonial.beforeScore === 0 ? 'No credit' : testimonial.beforeScore} → {testimonial.afterScore}
                        </div>
                      )}
                    </div>
                  </div>

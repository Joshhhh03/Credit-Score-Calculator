      ...
      if (!userData && user) {
        ...
        if (data.success) {
          ...
          if (format === "txt") {
            ...
            downloadTextFile(
              textReport,
              `creditbridge-report-${user.firstName}-${user.lastName}-${new Date().toISOString().split("T")[0]}.txt`,
            );
          } else if (format === "json") {
            const jsonData = JSON.stringify(currentUserData, null, 2);
            downloadTextFile(
              jsonData,
              `creditbridge-data-${user.firstName}-${user.lastName}-${new Date().toISOString().split("T")[0]}.json`,
            );
          }
        }
      } else if (userData) {
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Download your financial profile and credit data in a secure,
            readable format
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-3">
                  Complete profile summary with all your financial data,
                  recommendations, and analytics in an easy-to-read format.
                </p>
            ...
            >
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-3">
                  Complete structured data export for technical users or data
                  portability.
                </p>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="flex items-center">
                    ...
                    <span>
                      Employment:{" "}
                      {userData.financialData.employment.employerName ||
                        "Not provided"}
                    </span>
                  </div>
                  <div className="flex items-center">
                    ...
                    <span>
                      Bank:{" "}
                      {userData.financialData.banking.bankName ||
                        "Not provided"}
                    </span>
                  </div>
                  <div className="flex items-center">
          ...
          <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
            ...
            <p className="text-sm text-yellow-700">
              Your exported data contains sensitive financial information.
              Please store it securely and do not share it with unauthorized
              parties. CreditBridge takes your privacy seriously.
            </p>
          </div>

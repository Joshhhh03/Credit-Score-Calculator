  ...
  const coachingGoals: CoachingGoal[] = [
    {
      ...
      description:
        "Establish a 3-month emergency fund to improve financial stability",
      currentScore: 65,
      targetScore: 80,
      timeframe: "6 months",
      difficulty: "medium",
  ...
  const learningModules: LearningModule[] = [
    {
      ...
      description:
        "Learn how alternative credit scoring works and what factors matter most",
      duration: "15 min",
      difficulty: "Beginner",
      completed: true,
    ...
    },
    {
      ...
      description:
        "Understand how rent, utilities, and employment history impact your score",
      duration: "20 min",
      difficulty: "Beginner",
      completed: false,
      category: "Credit Education",
    ...
    },
    {
      ...
      description:
        "Compare traditional FICO scoring with alternative credit models",
      duration: "18 min",
    ...
    },
    {
      ...
      description:
        "Deep dive into payment history, utilization, and credit mix",
      duration: "25 min",
      difficulty: "Intermediate",
      completed: false,
      category: "Credit Education",
    ...
    },
    {
      ...
      description:
        "Create budgets that support strong credit profiles and financial stability",
      duration: "30 min",
      difficulty: "Beginner",
      completed: false,
    ...
    },
    {
      ...
      description:
        "Step-by-step guide to building financial resilience and credit backup",
      duration: "25 min",
      difficulty: "Intermediate",
      completed: false,
      category: "Savings",
    ...
    },
    {
      ...
      description:
        "Strategies for paying down debt while maintaining good credit",
      duration: "40 min",
      difficulty: "Intermediate",
      completed: false,
    ...
    },
    {
      ...
      description:
        "Learn to monitor your credit and protect against identity theft",
      duration: "28 min",
      difficulty: "Beginner",
      completed: false,
    ...
    },
    {
      ...
      description:
        "Create SMART financial goals that improve your credit over time",
      duration: "30 min",
      difficulty: "Beginner",
      completed: false,
      category: "Financial Planning",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Get personalized recommendations to improve your credit score and
            financial health
          </p>
        </div>
              ...
              <Card className="border-2 border-blue-200">
                <CardHeader>
                  <CardTitle className="flex items-center">
                    ...
                    Action Plan:{" "}
                    {coachingGoals.find((g) => g.id === selectedGoal)?.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {learningModules.map((module) => {
                ...
                return (
                  <Card
                    key={module.id}
                    className={`hover:shadow-lg transition-shadow ${isCompleted ? "border-green-200 bg-green-50" : ""}`}
                  >
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <div
                            className={`p-2 rounded-lg mr-3 ${isCompleted ? "bg-green-100 text-green-600" : "bg-blue-100 text-blue-600"}`}
                          >
                            {isCompleted ? (
                    ...
                    <CardContent>
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <Badge
                          className={getDifficultyBadgeColor(module.difficulty)}
                        >
                          {module.difficulty}
                        </Badge>
                      </div>
            ...
            <Card className="border-dashed border-2 border-gray-300">
              <CardContent className="text-center py-8">
                ...
                <p className="text-gray-600 mb-4">
                  Complete your current modules to unlock advanced financial
                  education content
                </p>
                <Button variant="outline">View Learning Path</Button>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="insights" className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-green-800">
                        Your rent payment consistency has improved 15% this
                        month
                      </span>
                    </div>
                    <div className="flex items-center">
                      <CheckCircle className="h-4 w-4 text-green-600 mr-3" />
                      <span className="text-sm text-green-800">
                        Cash flow stability is in the top 25% of users
                      </span>
                    </div>
                    <div className="flex items-center">
                      <CheckCircle className="h-4 w-4 text-green-600 mr-3" />
                      <span className="text-sm text-green-800">
                        Employment tenure is strengthening your profile
                      </span>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-yellow-800">
                        Utility payment timing could be more consistent
                      </span>
                    </div>
                    <div className="flex items-center">
                      <AlertTriangle className="h-4 w-4 text-yellow-600 mr-3" />
                      <span className="text-sm text-yellow-800">
                        Consider increasing your emergency fund ratio
                      </span>
                    </div>
                    <div className="flex items-center">
                      <AlertTriangle className="h-4 w-4 text-yellow-600 mr-3" />
                      <span className="text-sm text-yellow-800">
                        Adding more data sources could boost your score
                      </span>
                    </div>
                  </div>
                </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Personalized insights based on your financial profile and
                  behavior patterns
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-medium mb-2">
                      Score Optimization Opportunity
                    </h4>
                    <p className="text-sm text-gray-600 mb-3">
                      Based on your payment patterns, setting up autopay for
                      your utilities could increase your score by 8-12 points
                      within 60 days.
                    </p>
                    <Button
                      size="sm"
                      onClick={() => handleStartGoal("autopay-setup")}
                    >
                      <Target className="h-4 w-4 mr-2" />
                      Create Autopay Goal
                    </Button>
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      Your employment history is strong. Consider adding a
                      second income stream or side hustle to further improve
                      your financial profile.
                    </p>
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => handleStartCourse("financial-goals")}
                    >
      ...
      {selectedCourse && (
        <CourseContentModal
          ...
          courseTitle={
            learningModules.find((m) => m.id === selectedCourse)?.title || ""
          }
          duration={
            learningModules.find((m) => m.id === selectedCourse)?.duration || ""
          }
          difficulty={
            learningModules.find((m) => m.id === selectedCourse)?.difficulty ||
            ""
          }

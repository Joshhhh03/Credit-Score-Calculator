        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Get detailed insights into your credit profile, see your score
              trends, and discover personalized loan offers from top banks.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="trends" className="space-y-6">
                    ...
                    {historicalData.length > 1 && (
                      <polyline
                        ...
                        points={historicalData
                          .map((point, index) => {
                            const x =
                              50 + (index / (historicalData.length - 1)) * 700;
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600">
                      ...
                      {Math.max(...historicalData.map((d) => d.score)) -
                        Math.min(...historicalData.map((d) => d.score))}
                    </div>
                      ...
                      {offers.slice(0, 4).map((offer: any, index: number) => (
                        ...
                        >
                          <div className="flex justify-between items-start mb-3">
                            ...
                            <Badge
                              className={`${
                                offer.approvalLikelihood >= 85
                                  ? "bg-green-100 text-green-700"
                                  : offer.approvalLikelihood >= 70
                    ...
                    {offers.length > 4 && (
                      <div className="text-center mt-4">
                        <Button variant="outline">
                          View All {offers.length} {loanType.replace("-", " ")}{" "}
                          Offers
          ...
          <TabsContent value="factors" className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              {Object.entries(currentScore.factors).map(
                ([factor, score]: [string, any]) => {
